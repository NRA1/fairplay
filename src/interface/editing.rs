...
use iced_graphics::image::image_rs::Rgb;
use image::RgbaImage;
...
impl EditingView {
    pub(crate) fn new(img: RgbaImage) -> Self {
        let nodes = vec![
            Node {
                modifier: Modifier::BoxBlur(BoxBlurOptions::default()),
                offset: Vector::new(50.0, 50.0),
            },
            Node {
                modifier: Modifier::Sobel(SobelOptions::default()),
                offset: Vector::new(200.0, 50.0),
            }
        ];
